...
import { Card, CardHeader, CardBody, CardFooter, Divider, Link, Spinner, Code } from "@nextui-org/react";
...
export default function CardItem({ params }: CardItemProps) {
    ...
    const [formattedData, setFormattedData] = useState<GeminiFormattedData | undefined>(undefined);
